...
void CPlayer::Progress()
{
	...
	m_Info.vDir = vMousePos - m_vConPos;
	...
	m_vPoint = D3DXVECTOR2(100.f * cosf(m_fAngle) + m_vConPos.x,
		-100.f *sinf(m_fAngle) + m_vConPos.y);
	...
	for(int i =0; i<4; i++)
	{
		...
		m_vConPoint[i] -= D3DXVECTOR3(400, 300, 0);
...
{
	Rectangle(hdc,m_vConPoint[2].x - 10.f , m_vConPoint[2].y - 10.f
		, m_vConPoint[2].x + 10.f , m_vConPoint[2].y +10.f);
	Rectangle(hdc,m_vConPoint[1].x - 10.f , m_vConPoint[1].y - 10.f
		, m_vConPoint[1].x + 10.f , m_vConPoint[1].y +10.f);
